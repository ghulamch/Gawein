...
@section('content')
    <div class="glass-panel p-6 rounded-2xl">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <h3 class="font-heading font-bold text-xl text-slate-800">Laporan Transaksi Pembayaran</h3>
            ...
            <table class="w-full text-left border-collapse min-w-[800px]">
                <thead>
                    <tr class="border-b border-slate-200">
                        <th class="py-3 text-sm font-semibold text-slate-500 uppercase tracking-wider">ID Transaksi</th>
                        <th class="py-3 text-sm font-semibold text-slate-500 uppercase tracking-wider">Pengguna</th>
                        <th class="py-3 text-sm font-semibold text-slate-500 uppercase tracking-wider">Jumlah (Rp)</th>
                        <th class="py-3 text-sm font-semibold text-slate-500 uppercase tracking-wider">Metode Pembayaran</th>
                ...
                <tbody class="divide-y divide-slate-100">
                    <tr>
                        <td colspan="5" class="py-12 text-center text-slate-500">
                            ...
                            <span class="font-medium">Data transaksi belum tersedia (Tahap Pengembangan).</span>
                        </td>
                    </tr>
                </tbody>
            </table>
